                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card">
                                <div class="card-body overflow-hidden position-relative">
                                    ...
                                    <p class="text-muted mt-3 mb-0">New common language will be more simple and regular than
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card">
                                <div class="card-body overflow-hidden position-relative">
                                    ...
                                    <h5 class="mt-3">What is Lorem Ipsum?</h5>
                                    <p class="text-muted mt-3 mb-0">To an English person, it will seem like simplified
