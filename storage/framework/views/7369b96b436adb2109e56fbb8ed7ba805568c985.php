                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="<?php if(Route::has('password.request')): ?> <?php echo e(route('password.request')); ?> <?php endif; ?>" class="text-muted">Forgot
                                                                password?</a>
                                                        </div>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Don't have an account ? <a
                                                    href="<?php echo e(route('register')); ?>" class="text-primary fw-semibold">
                                                    Signup now </a> </p>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/auth/login.blade.php ENDPATH**/ ?>